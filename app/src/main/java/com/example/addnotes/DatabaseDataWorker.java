...
public class DatabaseDataWorker {
    ...
    public void insertCourses() {
        ...
        insertCourse("kotlin_core", "Kotlin Fundamentals: The Core Platform");
    }
    ...
    private void insertCourse(String courseId, String title) {
        ...
        values.put(NotesCollectionDBContract.CourseInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(NotesCollectionDBContract.CourseInfoEntry.COLUMN_TITLE, title);

        long newRowId = mDb.insert(NotesCollectionDBContract.CourseInfoEntry.TABLE_NAME, null, values);
    }

     private void insertNote(String courseId, String title, String text) {
        ContentValues values = new ContentValues();
        values.put(NotesCollectionDBContract.NoteInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(NotesCollectionDBContract.NoteInfoEntry.COLUMN_TITLE, title);
        values.put(NotesCollectionDBContract.NoteInfoEntry.COLUMN_TEXT, text);

        long newRowId = mDb.insert(NotesCollectionDBContract.NoteInfoEntry.TABLE_NAME, null, values);
    }
